...
export async function questionAnswerHandler(
    bot: Telegraf<Context>,
    ctx: Context<Update.PollAnswerUpdate>,
) {
    ...
    const currentQuestion: IQuiz =
        userState.currentListQuestions[userState.currentIndexQuestion];
