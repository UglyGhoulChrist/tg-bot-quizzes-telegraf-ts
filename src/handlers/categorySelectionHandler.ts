...
export async function categorySelectionHandler(bot: Telegraf<Context>, ctx: Context) {
    ...
    const currentListQuestions: IQuiz[] = changeListAnswersAndSelectFact(data[currentCategory].listQuestions)
